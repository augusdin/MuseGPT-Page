...
* 支持Command+M快捷键呼出面板提炼(Windows下为Ctrl+M)
* 支持将任意页面语言翻译提炼到你的的语言
...
### MuseGPT Page Panel (Light Theme) 

<img  width="400" src="./resource/panel_light.jpg">

### MuseGPT Page Panel (Dark Theme) 

<img  width="400" src="./resource/panel_dark.jpg">

### Option Prompts Edit 

<img  width="400" src="./resource/option_prompt.jpg">
