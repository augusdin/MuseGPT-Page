import { D as DEFAULT_OPTIONS, b as DEFAULT_PROMPTOPTIONS, i as i18n } from "./config.js";
...
const logo = "data:image/png;base64,";
...
const initLocalBaseOption = async () => {
  const { museOptions } = await chrome.storage.local.get(["museOptions"]);
  console.log("Options:", museOptions);
  if (museOptions) {
    const museOption = museOptions;
    return museOption;
  } else {
    const museOptions2 = DEFAULT_OPTIONS;
    console.log("\u521D\u59CB\u5316\u914D\u7F6E:", museOptions2);
    await chrome.storage.local.set({ museOptions: museOptions2 });
    return museOptions2;
  }
};
const initPromptOption = async () => {
  const { musePromptOptions } = await chrome.storage.local.get([
    "musePromptOptions"
  ]);
  console.log("musePromptOptions:", musePromptOptions);
  if (musePromptOptions) {
    const musePromptOption = musePromptOptions;
    return musePromptOption;
  } else {
    console.log("\u672C\u5730\u6CA1\u6709prompt\u914D\u7F6E");
    const language = DEFAULT_PROMPTOPTIONS.language;
    const useKey = DEFAULT_PROMPTOPTIONS.useKey;
    const category = DEFAULT_PROMPTOPTIONS.category;
    const musePromptOptions2 = {
      language,
      category,
      useKey,
      prompts: DEFAULT_PROMPTOPTIONS.prompts
    };
    await chrome.storage.local.set({ musePromptOptions: musePromptOptions2 });
    console.log("\u5DF2\u521D\u59CB\u5316\u672A:", musePromptOptions2);
    return musePromptOptions2;
  }
};
...
const ReactIs = /* @__PURE__ */ getDefaultExportFromCjs(reactIs$2.exports);
...
const Modal$2 = /* @__PURE__ */ react.exports.forwardRef(function Modal(props, forwardedRef) {
...
function createBreakpoints(breakpoints) {
  const {
    ...
    unit = "px",
    step = 5
  } = breakpoints, other = _objectWithoutPropertiesLoose(breakpoints, _excluded$R);
...
function createBox(options = {}) {
  ...
  const Box2 = /* @__PURE__ */ react.exports.forwardRef(function Box3(inProps, ref) {
    ...
    const _extendSxProp = extendSxProp(inProps), {
      className,
      component = "div"
    } = _extendSxProp, other = _objectWithoutPropertiesLoose(_extendSxProp, _excluded$O);
...
function createStyled2(input = {}) {
  ...
  return (tag, inputOptions = {}) => {
    ...
    const {
      ...
      skipSx: inputSkipSx,
      overridesResolver
    } = inputOptions, options = _objectWithoutPropertiesLoose(inputOptions, _excluded$M);
...
const _excluded$E = ["BackdropComponent", "BackdropProps", "classes", "className", "closeAfterTransition", "children", "container", "component", "components", "componentsProps", "disableAutoFocus", "disableEnforceFocus", "disableEscapeKeyDown", "disablePortal", "disableRestoreFocus", "disableScrollLock", "hideBackdrop", "keepMounted", "onBackdropClick", "onClose", "open", "slotProps", "slots", "theme"];
...
const _excluded$w = ["className", "color", "component", "onBlur", "onFocus", "TypographyClasses", "underline", "variant", "sx"];
...
const TouchRipple = /* @__PURE__ */ react.exports.forwardRef(function TouchRipple2(inProps, ref) {
  ...
  const startTimer = react.exports.useRef(0);
...
const _excluded$p = ["children", "disabled", "id", "loading", "loadingIndicator", "loadingPosition", "variant"];
...
const BootstrapDialogTitle = (props) => {
  ...
  return /* @__PURE__ */ jsxs(DialogTitle$1, {
    ...
    ...other,
    children: [children, onClose ? /* @__PURE__ */ jsx(IconButton$1, {
      "aria-label": "close",
      onClick: onClose,
      sx: {
        position: "absolute",
...
const NotionOAuthDialog = ({
  onClose,
  open,
  theme
}) => /* @__PURE__ */ jsxs(BootstrapDialog, {
  onClose: () => {
    onClose(false);
  },
  ...
  children: [/* @__PURE__ */ jsx(BootstrapDialogTitle, {
    ...
    children: i18n("notion_oauth_dialog_title")
  }), /* @__PURE__ */ jsxs(DialogContent$1, {
    dividers: true,
    children: [/* @__PURE__ */ jsxs(Typography$1, {
      gutterBottom: true,
      fontWeight: "bold",
      children: [i18n("notion_oauth_dialog_content_line1"), " ", /* @__PURE__ */ jsx("br", {}), /* @__PURE__ */ jsx(Typography$1, {
        fontWeight: "bold",
        color: "secondary.main",
        component: "span",
        children: i18n("notion_oauth_dialog_content_line2")
      })]
    }), /* @__PURE__ */ jsx("p", {
      children: /* @__PURE__ */ jsxs(Typography$1, {
        gutterBottom: true,
        children: [/* @__PURE__ */ jsxs(Typography$1, {
          fontWeight: "bold",
          children: [i18n("notion_oauth_dialog_content_line3"), " ", /* @__PURE__ */ jsx("br", {})]
        }), /* @__PURE__ */ jsxs(Typography$1, {
          fontWeight: "bold",
          color: "secondary.main",
          component: "span",
          children: [i18n("notion_oauth_dialog_content_line4"), " ", /* @__PURE__ */ jsx("br", {})]
        }), /* @__PURE__ */ jsx(Typography$1, {
          fontWeight: "bold",
          children: i18n("notion_oauth_dialog_content_line5")
        }), /* @__PURE__ */ jsx(Typography$1, {
          children: i18n("notion_oauth_dialog_content_line6")
        }), /* @__PURE__ */ jsx(Typography$1, {
          children: i18n("notion_oauth_dialog_content_line7")
        })]
      })
    }), /* @__PURE__ */ jsx("p", {
      children: /* @__PURE__ */ jsxs(Typography$1, {
        gutterBottom: true,
        children: [i18n("notion_oauth_dialog_content_line8"), /* @__PURE__ */ jsx(Link$1, {
          sx: theme ? {
            "&:hover": {
          ...
          underline: "none",
          href: "#",
          children: i18n("notion_oauth_dialog_content_line9")
        })]
      })
    }), /* @__PURE__ */ jsxs(Typography$1, {
      gutterBottom: true,
      children: [i18n("notion_oauth_dialog_content_line10"), /* @__PURE__ */ jsx("br", {}), `${i18n("notion_oauth_dialog_content_line11")}`, /* @__PURE__ */ jsx("br", {}), `${i18n("notion_oauth_dialog_content_line12")}`, /* @__PURE__ */ jsx(Link$1, {
        sx: theme ? {
          "&:hover": {
            color: theme.palette.text.primary
          }
        ...
        color: "primary",
        underline: "none",
        href: "https://musegpt.net/term/musegpt-privacy-policy/",
        children: i18n("notion_oauth_dialog_content_policy_link")
      })]
    })]
  }), /* @__PURE__ */ jsx(DialogActions$1, {
    children: /* @__PURE__ */ jsx(LoadingButton$1, {
      ...
      children: /* @__PURE__ */ jsx("span", {
        ...
        children: i18n("notion_oauth_dialog_ok_btn")
      })
    })
  })]
});
...
const _excluded$o = ["className", "color", "enableColorOnDark", "position"];
...
const _excluded$8 = ["onEntering"], _excluded2$2 = ["action", "anchorEl", "anchorOrigin", "anchorPosition", "anchorReference", "children", "className", "container", "elevation", "marginThreshold", "open", "PaperProps", "slots", "slotProps", "transformOrigin", "TransitionComponent", "transitionDuration", "TransitionProps"], _excluded3 = ["slotProps"];
...
const SnackbarContent = /* @__PURE__ */ react.exports.forwardRef(function SnackbarContent2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiSnackbarContent"
  });
...
const Snackbar = /* @__PURE__ */ react.exports.forwardRef(function Snackbar2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiSnackbar"
  });
...
Object.defineProperty(DoneOutlined, "__esModule", {
  value: true
});
var default_1 = DoneOutlined.default = void 0;
var _createSvgIcon = _interopRequireDefault(requireCreateSvgIcon());
var _jsxRuntime = require$$2;
var _default = (0, _createSvgIcon.default)(/* @__PURE__ */ (0, _jsxRuntime.jsx)("path", {
  d: "M9 16.2 4.8 12l-1.4 1.4L9 19 21 7l-1.4-1.4L9 16.2z"
}), "DoneOutlined");
default_1 = DoneOutlined.default = _default;
const _100 = "";
const _300 = "";
const _400 = "";
const _500 = "";
...
export {
  ...
  default_1$1 as D,
  Dialog$1 as E,
  DialogContent$1 as F,
  DialogActions$1 as G,
  initLocalBaseOption as H,
  initPromptOption as I,
  v4 as J,
  createRoot as K,
  Link$1 as L,
  MuiAlert as M,
  NotionOAuthDialog as N,
  ReactIs as O,
  Fragment as P,
  ButtonBase$1 as Q,
  React as R,
